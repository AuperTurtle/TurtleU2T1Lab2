public class ChatBot {
    ...
    public int multiplyNumber(int num1, int num2, int num3) {return num1 * num2 * num3;}

    public void favoritePet(String favPet) {
        System.out.println(favPet + " is a good pet too!");
